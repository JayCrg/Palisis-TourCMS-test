...
// For this activity we can simply use a text string as the parameter for the API,
// but in a real-world scenario we would use an array like the one below
// which would be converted to a single string with the '&' character separating each parameter
$params_for_api = "product_type=4&country=ES&page=".$page."&per_page=".$per_page;
// $params = [
//     'product_type=4',
//     'country=ES',
//     'page=' . $page,
...
$result = $tourcms->search_tours($params_for_api, $channel_id);

if ($result->error == 'OK' && $result->total_tour_count > 0) {
    $total_pages_number = ceil($result->total_tour_count / $per_page);
}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div id="container">
                        ...
                        <!--- Pagination added in order to provide an easier navigation experience-->
                        <div id=select-opciones>
                            <form action="index.php" method="get">
                                <div class="form-group">
                                    <label for="requested_page">Page:</label>
                                    <input type="number" name="requested_page" id="requested_page" value="<?= $page ?>" min="1" max="<?= $total_pages_number ?>" required>
                                ...
                                <?php
                                // Loop through the tours and display them on the page
                                $i = 0;
                                foreach ($result->tour as $tour) :
                                    $i++;
                                ?>
                                    <h1><?= ($page-1)*$per_page + $i ?></h1>
                                    <div class="row">
                                        ...
                                        <div class="col-12" id="postsdasd-49" class="post-49 tour type-tour status-publish hentry tag-inline product-type-day-tours location-berlin">
                                            <div class="card tour-desktop">
                                                <div class="tourcms-card-horizontal">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="left">
                                                            <span class="tourcms-badge-tourtype-horizontal"><a href="https://wordpress.tourcms.com/tours-by-type/day-tours/" rel="tag">Day tours</a></span><span class="tourcms-badge-location-horizontal"> <a href=<?php echo $tour->tour_url ?> rel="tag"><?php echo $tour->location ?></a></span>
                                                        </div>
                                                        ...
                                                        <div class="card-meta-right">
                                                            <h5 class="tourcms-card-title"><?php echo $tour->name ?></h5>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                            <div class="card tour-mobile">
                                                ...
                                                <div id="c-49-m" class="carousel slide" data-interval="false">
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                            <img class="d-block w-100" src=<?= $tour->thumbnail_image ?> alt='Image of <?= $tour->name ?>'>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-title"><?= $tour->name ?></h5>
                                                    <div style="margin-top:-0.8rem;"><span class="badge badge-location"> <a href=<?= $tour->tour_url ?> rel="tag"><?= $tour->location ?></a></span><span class="badge badge-tourtype"><a href="https://wordpress.tourcms.com/tours-by-type/day-tours/" rel="tag"> Day tours</a></span></div>
                                                    <!--              <p class="card-text"><i class="fas fa-history" style=""></i> <b>Duration:</b> 4 hours</p>-->
                                                    <p class="tourcms-card-text"><?= $tour->summary ?></p>
                                                </div>
                                                <div class="card-footer bg-transparent">
                                                    <p class="tourcms-card-text tour-mobile-footer-left"> <b>Duration:</b> <?= $tour->duration_desc ?><br></p>
                                                    <p class="tourcms-card-text tour-mobile-footer-right" style=""><a href=<?= $tour->tour_url ?>>Book now <span class='fromprice'>from &#8364;<?= $tour->from_price ?></span></a><br></p>
                                                </div>
                                            </div>
                                        </div>
